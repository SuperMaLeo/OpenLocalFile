...
chooseFileButton.addEventListener('click', function (e) {
  ...
  window.webkitRequestFileSystem(window.TEMP, 20 * 1024 * 1024, function () {
    dataDirectory = "filesystem:file:///D:/";
    window.webkitResolveLocalFileSystemURL(dataDirectory, function (directoryEntry) {
      console.log('success', directoryEntry);
      directoryEntry.getFile('SSSSS.txt', { reate: false, exclusive: true }, function (fileEntry) {
        document.querySelector('#file_path').value = fileEntry.name + 'D';
      }, errorHandler);
    }, errorHandler);
  }, errorHandler);

  // var url = 'filesystem:file:///D:/SSSSS.txt';
  // window.webkitResolveLocalFileSystemURL(url, function (fileEntry) {
  //   document.querySelector('#file_path').value = fileEntry.name + 'D';
  // });

  // var s = document.querySelector('#localFileUrl');
  // document.querySelector('#file_path').value = s + 'D';
  ...
  //     (function (f) {
  //       var n = f.name;
  //       fs.root.getFile(n, { create: false, exclusive: true }, function (fileEntry) {
  //         document.querySelector('#file_path').value = fileEntry.name + 'D';
  //       }, errorHandler);
  //     })(files[0]);
  ...
  // window.webkitRequestFileSystem(window.TEMPORARY, 1024 * 1024, function (fs) {
  //   fs.root.getFile('D:/SSSSS.txt', {create: false, exclusive: true}, function (fileEntry) {
  //     document.querySelector('#file_path').value = fileEntry.name + 'D';
  //   },
  //     function (evt) {
  ...
  //       document.querySelector('#file_path').value = ab + 'D';
  //     };
  ...
  // window.webkitResolveLocalFileSystemURL("file:///D:/SSSSS.txt", function (fileEntry) {
  ...
  //   }
  // };
  // xmlhttp.open("GET", "C:/Users/leo/Desktop/New Text Document.txt", true);
  // xmlhttp.send();
  ...
  //     document.querySelector('#file_path').value = txt + 'D';
  //   }
  // };
  // // xhr.timeout = 10000;
  // // open 設為 true 就是非同步, 設成 false 就是同步
  // xhr.open("GET", 'file:///D:/SSSSS.txt', true);
